package com.example.sudha.sunshine.data;
...
public class WeatherProvider extends ContentProvider
{
                        ...
                        String sortOrder)
    {
        ...
        switch (sUriMatcher.match(uri))
        {
            ...
            case LOCATION_ID:
            {
                retCursor = mOpenHelper.getReadableDatabase().query(WeatherContract.LocationEntry.TABLE_NAME,projection, WeatherContract.LocationEntry._ID
                                                                          + " = '" + ContentUris.parseId(uri) + "'", null, null, null, sortOrder);
                break;
            }
            // "location"
            case LOCATION:
